            ...
            <div className="flex flex-wrap">
              <div className="w-full lg:w-3/4 p-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                  ...
                  <div className=" p-4  transform transition duration-300 hover:scale-105 cursor-pointer">
                    ...
                    <p className="text-orange-500 text-sm">$28.00 </p>
                  </div>
                  ...
                  <div className=" p-4  transform transition duration-300 hover:scale-105 cursor-pointer">
                    ...
                    <p className="text-orange-500 text-sm">$45.00</p>
                  </div>
                  ...
                  <div className=" p-4  transform transition duration-300 hover:scale-105 cursor-pointer">
                    ...
                    <p className="text-orange-500 text-sm">$43.00</p>
                  </div>
                  <div className=" p-4  transform transition duration-300 hover:scale-105 cursor-pointer">
                    <Image
                      src="/shopG7.jpg"
                    ...
                    <p className="text-orange-500 text-sm">$10.00</p>
                  </div>
                  <div className=" p-4  transform transition duration-300 hover:scale-105 cursor-pointer">
                    <Image
                      src="/shopG8.jpg"
                    ...
                    <p className="text-orange-500 text-sm">$25.00 </p>
                  </div>
                  <div className=" p-4  transform transition duration-300 hover:scale-105 cursor-pointer">
                    <Image
                      src="/shopG9.jpg"
                    ...
                    <p className="text-orange-500 text-sm">$12.00</p>
                  </div>
                  <div className=" p-4  transform transition duration-300 hover:scale-105 cursor-pointer">
                    <Image
                      src="/shopG4.jpg"
              ...
              <div className="w-full lg:w-1/4 p-4 shadow-md">
                <div className="mb-4 flex">
                  ...
                  <FaSearch className="bg-orange-500 text-white p-2 text-[40px]" />
                </div>
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute inset-0  px-4 text-white">
                      <div className=" p-5 mt-1 ">
                        ...
                        <p className="text-orange-500 mt-2 text-xs font-semibold">
                          45.00${" "}
                        </p>
                      </div>
                ...
                <div className=" overflow-hidden mt-2">
                  <div className="p-3">
                    ...
                    <div className="grid lg:grid-cols-2 gap-2  ">
                      <div className="text-gray-600  cursor-pointer  text-left">
                        Services
                      </div>
                      <div className="text-gray-600  cursor-pointer  text-left">
                        Our menu
                      ...
                      <div className="tex t-gray-600   cursor-pointer    text-left">
                        Cupcake
                      </div>
                      <div className="text-orange-500 cursor-pointer   underline text-left">
                        Burger
                      </div>
                      <div className="text-gray-600  cursor-pointer  text-left">
                        Cookies
